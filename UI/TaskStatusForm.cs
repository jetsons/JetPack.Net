...
namespace Jetsons.JetPack {
	...
	/// <summary>
	/// Dialog that runs a single task in the background and displays its status.
	/// </summary>
	public class TaskStatusForm : Form {
		...
		public Action<TaskStatusForm> TaskDelegate;
		public bool AutoClose = false;
		public bool AllDone = false;

		public void Init(string dialogTitle, int totalSteps, Action<TaskStatusForm> task) {
		...
		/// <summary>
		/// Move the progress bar ahead, optionally logging an event.
		/// You must call this from your delegate in order to show progress in the dialog.
		/// </summary>
		/// <param name="text"></param>
		public void NextStep(string text = null) {

			// execute the work delegate
			CurrentStep++;
			AllDone = CurrentStep == (TotalSteps - 1);
