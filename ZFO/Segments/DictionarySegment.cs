...
using Jetsons.ZFO.Comparers;
using Jetsons.ZFO.Formatters;
using Jetsons.ZFO.Internal;

namespace Jetsons.ZFO.Segments
{
        ...
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        ICollection<TKey> IDictionary<TKey, TValue>.Keys
        {
            get
            {
                throw new NotSupportedException("Jetsons.ZFO Dictionary does not support Keys; use GetEnumerator instead.");
            }
        }
        ...
        ICollection<TValue> IDictionary<TKey, TValue>.Values
        {
            get
            {
                throw new NotSupportedException("Jetsons.ZFO Dictionary does not support Values; use GetEnumerator instead.");
            }
        }
