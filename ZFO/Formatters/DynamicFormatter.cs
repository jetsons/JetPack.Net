...
namespace Jetsons.ZFO.Formatters
{
    ...
    internal static class DynamicFormatter
    {
            ...
            where TTypeResolver : ITypeResolver, new()
        {
            ...
            var generateTypeInfo = BuildFormatter(Jetsons.ZFO.Segments.DynamicAssemblyHolder.Module, resolverType, t, members);
    ...
    internal static class DynamicStructFormatter
    {
            ...
            where TTypeResolver : ITypeResolver, new()
        {
            ...
            else
            {
                ...
                var generateTypeInfo = BuildFormatter(Jetsons.ZFO.Segments.DynamicAssemblyHolder.Module, resolverType, elementType, length, members);
                var formatter = Activator.CreateInstance(generateTypeInfo.AsType());
    ...
    internal static class DynamicUnionFormatter
    {
        ...
        {
            var moduleBuilder = Jetsons.ZFO.Segments.DynamicAssemblyHolder.Module;
