...
namespace Jetsons.ZFO.Internal
{
    ...
    public static class BinaryUtil
    {
        static BinaryUtil()
        {
            ...
            {
                throw new Exception("Currently Jetsons.ZFO only supports Little-Endian environments. If you need supports, please report your envitonments to https://github.com/neuecc/Jetsons.ZFO/issues .");
            }
        }
