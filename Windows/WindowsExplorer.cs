...
namespace Jetsons.JetPack.Windows {
	...
	public static class WindowsExplorer {
		...
		private static List<FileSystemInfo> PathToFileSystemInfo(IEnumerable<string> paths) {
			...
			foreach (var path in paths) {
				...
				if (Directory.Exists(fixedPath)) {
					results.Add(new DirectoryInfo(fixedPath));
				}
				else if (File.Exists(fixedPath)) {
					results.Add(new FileInfo(fixedPath));
				}
			}
			return results;
		}

		public static void LaunchSingle(string path, bool edit = false) {
		...
		public static void LaunchMultiple(string parentDirectory, List<string> filenames) {
