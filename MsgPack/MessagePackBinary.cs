using Jetsons.MsgPack.Decoders;
...
{
    /// <summary>
    /// Encode/Decode Utility of Jetsons.MsgPack Spec.
    ...
    public static partial class MessagePackBinary
    {
        ...
        static int ReadMessageBlockFromStreamCore(Stream stream, ref byte[] bytes, int offset, bool readOnlySingleMessage)
        {
            ...
            {
                throw new InvalidOperationException("Invalid Jetsons.MsgPack code was detected, code:" + byteCode);
            }
...
namespace Jetsons.MsgPack.Decoders
{
