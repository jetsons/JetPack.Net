...
namespace Jetsons.MsgPack.Resolvers
{
    ...
    public sealed class DynamicObjectResolver : IFormatterResolver
    {
        ...
        const string ModuleName = "Jetsons.MsgPack.Resolvers.DynamicObjectResolver";
    ...
    public sealed class DynamicContractlessObjectResolver : IFormatterResolver
    {
        ...
        const string ModuleName = "Jetsons.MsgPack.Resolvers.DynamicContractlessObjectResolver";
...
namespace Jetsons.MsgPack.Internal
{
    internal static class DynamicObjectTypeBuilder
    {
        ...
        public static TypeInfo BuildType(DynamicAssembly assembly, Type type, bool forceStringKey, bool contractless)
        {
            ...
            var serializationInfo = Jetsons.MsgPack.Internal.ObjectSerializationInfo.CreateOrNull(type, forceStringKey, contractless, false);
            if (serializationInfo == null) return null;

            var formatterType = typeof(IMessagePackFormatter<>).MakeGenericType(type);
            var typeBuilder = assembly.DefineType("Jetsons.MsgPack.Formatters." + SubtractFullNameRegex.Replace(type.FullName, "").Replace(".", "_") + "Formatter" + Interlocked.Increment(ref nameSequence), TypeAttributes.Public | TypeAttributes.Sealed, null, new[] { formatterType });
