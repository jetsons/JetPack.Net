...
namespace Jetsons.MsgPack.Resolvers
{
    ...
    public sealed class DynamicEnumResolver : IFormatterResolver
    {
        ...
        const string ModuleName = "Jetsons.MsgPack.Resolvers.DynamicEnumResolver";
        ...
        static TypeInfo BuildType(Type enumType)
        {
            ...
            var typeBuilder = assembly.DefineType("Jetsons.MsgPack.Formatters." + enumType.FullName.Replace(".", "_") + "Formatter" + Interlocked.Increment(ref nameSequence), TypeAttributes.Public | TypeAttributes.Sealed, null, new[] { formatterType });
