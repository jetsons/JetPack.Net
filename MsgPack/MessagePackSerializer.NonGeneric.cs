...
namespace Jetsons.MsgPack
{
    ...
    public static partial class MessagePackSerializer
    {
        public static class NonGeneric
        {
            ...
            static readonly Jetsons.MsgPack.Internal.ThreadsafeTypeKeyHashTable<CompiledMethods> serializes = new Jetsons.MsgPack.Internal.ThreadsafeTypeKeyHashTable<CompiledMethods>(capacity: 64);
