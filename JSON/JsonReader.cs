...
namespace Jetsons.JSON
{
    ...
    public struct JsonReader
    {
        ...
        public Single ReadSingle()
        {
            SkipWhiteSpace();
            int readCount;
            var v = Jetsons.JSON.Internal.DoubleConversion.StringToDoubleConverter.ToSingle(bytes, offset, out readCount);
            if (readCount == 0)
            {
                throw CreateParsingException("Number Token");
            }
        ...
        public Double ReadDouble()
        {
            SkipWhiteSpace();
            int readCount;
            var v = Jetsons.JSON.Internal.DoubleConversion.StringToDoubleConverter.ToDouble(bytes, offset, out readCount);
            if (readCount == 0)
            {
                throw CreateParsingException("Number Token");
            }
