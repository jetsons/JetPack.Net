...
using Jetsons.JSON.Internal.Emit;
using Jetsons.JSON.Internal;
using Jetsons.JSON.Formatters;
using System.Text.RegularExpressions;
using System.Threading;
using System.Reflection.Emit;
using Jetsons.JSON.Resolvers.Internal;

namespace Jetsons.JSON.Resolvers
{
    /// <summary>
...
namespace Jetsons.JSON.Resolvers.Internal
{
...
#endif
    {
        ...
        const string ModuleName = "Jetsons.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateOriginal";
...
#endif
    {
        ...
        static readonly bool excludeNull = false;
        const string ModuleName = "Jetsons.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateCamelCase";
...
#endif
    {
        ...
        static readonly bool excludeNull = false;
        const string ModuleName = "Jetsons.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullFalseNameMutateSnakeCase";
...
#endif
    {
        ...
        const string ModuleName = "Jetsons.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateOriginal";
...
#endif
    {
        ...
        static readonly Func<string, string> nameMutator = StringMutator.ToCamelCase;
        static readonly bool excludeNull = true;
        const string ModuleName = "Jetsons.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateCamelCase";
...
#endif
    {
        ...
        static readonly Func<string, string> nameMutator = StringMutator.ToSnakeCase;
        static readonly bool excludeNull = true;
        const string ModuleName = "Jetsons.JSON.Resolvers.DynamicObjectResolverAllowPrivateFalseExcludeNullTrueNameMutateSnakeCase";
    ...
    internal static class DynamicObjectTypeBuilder
    {
        ...
        static TypeInfo BuildType(DynamicAssembly assembly, Type type, Func<string, string> nameMutator, bool excludeNull)
        {
            ...
            var typeBuilder = assembly.DefineType("Jetsons.JSON.Formatters." + SubtractFullNameRegex.Replace(type.FullName, "").Replace(".", "_") + "Formatter" + Interlocked.Increment(ref nameSequence), TypeAttributes.Public | TypeAttributes.Sealed, null, new[] { formatterType });
        ...
        internal static class EmitInfo
        {
...
#if NETSTANDARD
            public static readonly MethodInfo UnsafeMemory_MemoryCopy = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonWriter writer, byte[] src) => UnsafeMemory.MemoryCopy(ref writer, src));
#endif
            ...
            public static readonly MethodInfo NongenericSerialize = ExpressionUtility.GetMethodInfo<Jetsons.JSON.JsonWriter>(writer => JsonSerializer.NonGeneric.Serialize(default(Type), ref writer, default(object), default(IJsonFormatterResolver)));

            public static MethodInfo Serialize(Type type)
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod("Serialize", new[] { typeof(Jetsons.JSON.JsonWriter).MakeByRefType(), type, typeof(IJsonFormatterResolver) });
            }

            public static MethodInfo Deserialize(Type type)
            {
                return typeof(IJsonFormatter<>).MakeGenericType(type).GetRuntimeMethod("Deserialize", new[] { typeof(Jetsons.JSON.JsonReader).MakeByRefType(), typeof(IJsonFormatterResolver) });
            }
            ...
            {
                public static readonly MethodInfo GetEncodedPropertyNameWithBeginObject = ExpressionUtility.GetMethodInfo(() => Jetsons.JSON.JsonWriter.GetEncodedPropertyNameWithBeginObject(default(string)));

                public static readonly MethodInfo GetEncodedPropertyNameWithPrefixValueSeparator = ExpressionUtility.GetMethodInfo(() => Jetsons.JSON.JsonWriter.GetEncodedPropertyNameWithPrefixValueSeparator(default(string)));

                public static readonly MethodInfo GetEncodedPropertyNameWithoutQuotation = ExpressionUtility.GetMethodInfo(() => Jetsons.JSON.JsonWriter.GetEncodedPropertyNameWithoutQuotation(default(string)));

                public static readonly MethodInfo GetEncodedPropertyName = ExpressionUtility.GetMethodInfo(() => Jetsons.JSON.JsonWriter.GetEncodedPropertyName(default(string)));

                public static readonly MethodInfo WriteNull = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonWriter writer) => writer.WriteNull());
                public static readonly MethodInfo WriteRaw = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonWriter writer) => writer.WriteRaw(default(byte[])));
                public static readonly MethodInfo WriteBeginObject = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonWriter writer) => writer.WriteBeginObject());
                public static readonly MethodInfo WriteEndObject = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonWriter writer) => writer.WriteEndObject());
                public static readonly MethodInfo WriteValueSeparator = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonWriter writer) => writer.WriteValueSeparator());
            ...
            {
                public static readonly MethodInfo ReadIsNull = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonReader reader) => reader.ReadIsNull());
                public static readonly MethodInfo ReadIsBeginObjectWithVerify = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonReader reader) => reader.ReadIsBeginObjectWithVerify());
                public static readonly MethodInfo ReadIsEndObjectWithSkipValueSeparator = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonReader reader, int count) => reader.ReadIsEndObjectWithSkipValueSeparator(ref count));
                public static readonly MethodInfo ReadPropertyNameSegmentUnsafe = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonReader reader) => reader.ReadPropertyNameSegmentRaw());
                public static readonly MethodInfo ReadNextBlock = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonReader reader) => reader.ReadNextBlock());
                public static readonly MethodInfo GetBufferUnsafe = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonReader reader) => reader.GetBufferUnsafe());
                public static readonly MethodInfo GetCurrentOffsetUnsafe = ExpressionUtility.GetMethodInfo((Jetsons.JSON.JsonReader reader) => reader.GetCurrentOffsetUnsafe());
            ...
            {
                internal static readonly MethodInfo FormatterType = ExpressionUtility.GetPropertyInfo((Jetsons.JSON.JsonFormatterAttribute attr) => attr.FormatterType).GetGetMethod();
                internal static readonly MethodInfo Arguments = ExpressionUtility.GetPropertyInfo((Jetsons.JSON.JsonFormatterAttribute attr) => attr.Arguments).GetGetMethod();
            }
        }
